...
func PutAddImageToOHPost() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err == nil {
			c.JSON(http.StatusOK, PutImageAddToOHPostResponse(databaseImageChanged))
		} else {
...
func PutImageAddToOHPostResponse(changedImage models.Image) responses.ImageResponse {
